			...
			imgpanelBgType.change(function() {	
				...
				switch (value) 
				{
					case 'solid-color':
						...
						patternTitle.hide();
						imageTitle.hide();
						spanSolidValue.css('background-color', (JSNISClassicTheme['background-type-' + value] ) ? JSNISClassicTheme['background-type-' + value].firstValue : '#fff');
						imgpanelBgValueFirst.removeClass('input-xxlarge').addClass('input-mini');
					...
					case 'radial-gradient':
						...
						bgInputValueSecond.show();
						spanGradientFirstValue.css('background-color', (JSNISClassicTheme['background-type-' + value] ) ? JSNISClassicTheme['background-type-' + value].firstValue : '#fff');
						spanGradientSecondValue.css('background-color', (JSNISClassicTheme['background-type-' + value] ) ? JSNISClassicTheme['background-type-' + value].lastValue : '#fff');
						patternTitle.hide();
						imageTitle.hide();
						imgpanelBgValueFirst.removeClass('input-xxlarge').addClass('input-mini');
						imgpanelBgValueFirst.val((JSNISClassicTheme['background-type-' + value]) ? JSNISClassicTheme['background-type-' + value].firstValue : '');
