...
$lists['thumbnailPanelPresentation'] = JHTML::_('select.genericList', $thumbnailPanelPresentation, 'thumbnail_panel_presentation', 'class="inputbox thumbnailPanel"', 'value', 'text', $items->thumbnail_panel_presentation );
