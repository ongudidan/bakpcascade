				...
				<fieldset>
					...
					<div class="control-group">
						<label class="control-label editlinktip hasTip"
							title="<?php echo htmlspecialchars(JText::_('SHOWLIST_TITLE_SHOWLIST'));?>::<?php echo htmlspecialchars(JText::_('SHOWLIST_DES_SHOWLIST')); ?>"><?php echo JText::_('SHOWLIST_TITLE_SHOWLIST');?>
						</label>
						<div class="controls">
							<input class="jsn-input-xlarge-fluid" type="text"
								value="<?php echo htmlspecialchars($this->items->showlist_title);?>"
								name="showlist_title" id="showlist_title" /> <span
					...
					<div class="control-group">
						...
						<div class="controls">
							<input class="input-mini" type="text" name="hits"
