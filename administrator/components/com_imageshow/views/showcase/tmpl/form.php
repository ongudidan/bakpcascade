...
<div id="jsn-showcase-settings" class="jsn-page-edit" class="form-horizontal">
	<form action="index.php?option=com_imageshow&controller=showcase"
		...
		<div id="jsn_is_showcase_tabs" class="jsn-tabs">
			<ul>
				<li><a href="#jsn-showcase-details-tab"><?php echo JText::_('SHOWCASE_TITLE_SHOWCASE_DETAILS'); ?>
				</a></li>
				<li><a href="#jsn-showcase-themes-tab"><?php echo $text; ?> </a></li>
			</ul>
						...
						<div class="row-fluid show-grid">
							<div class="span6">
								<fieldset>
									...
									?>
									<div class="control-group">
										<label class="control-label"><?php echo JText::_('SHOWCASE_GENERAL_TITLE');?>
										</label>
										<div class="controls">
											<input class="jsn-input-xlarge-fluid" type="text"
												value="<?php echo $this->generalData['generalTitle']; ?>"
												name="showcase_title" id="showcase_title" /> <span
