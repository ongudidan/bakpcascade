 ...
 */!function ($) {
    ...
    function JSNItemList(options) {
        ...
        this.template = '<div class="controls"><div class="jsn-buttonbar"><button id="items-list-edit" class="btn btn-small"><i class="icon-pencil"></i>Edit</button><button id="items-list-save" class="btn btn-small btn-primary"><i class="icon-ok"></i>Done</button></div>' +
            ...
            '{{each(i, val) listItems}}<div class="jsn-item ui-state-default jsn-iconbar-trigger">' +
            ...
            '{{if actionField}}<div class="jsn-iconbar"><a class="element-action-edit" href="javascript:void(0)"><i class="icon-bolt"></i></a></div>{{/if}}' +
            '</div>{{/each}}' +
            '</div>' +
                ...
                success:function () {
                    ...
                    $.ajax({
                        ...
                        success:function (response) {
                            var listFieldShow = $("<div/>", {"class":"jsn-items-list"}), listFieldHide = $("<div/>", {"class":"jsn-items-list"});
                            if (response) {
                                    ...
                                    if (self.options.identify != item.options.identify) {
                                        ...
                                        if (item.options.hideField) {
                                            listFieldShow.append(
                                                $("<div/>", {"class":"jsn-item jsn-iconbar-trigger"}).append(
                            ...
                            if ($(listFieldShow).html()) {
                                ...
                                $(".control-list-action #jsn-action-show").append($("<div/>", {"class":"jsn-items-list"}).append(
                            ...
                            if ($(listFieldHide).html()) {
                                ...
                                $(".control-list-action #jsn-action-hide").append($("<div/>", {"class":"jsn-items-list"}).append(
                                    $("<div/>", {"class":"ui-state-disabled"}).append(
