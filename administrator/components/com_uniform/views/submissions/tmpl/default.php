	...
	<div class="pull-right jsn-fieldset-select">
		...
		<table class="table table-bordered table-striped jsn-table-centered">
			...
			<th width="10">
			    ...
			    ?>
			<th width="30">
				<?php echo JHtml::_('grid.sort', 'JGRID_HEADING_ID', 'sb.data_id', $listDirn, $listOrder); ?>
			</th>
			<th width="30">
		    ...
		    <tbody>
			    ...
			    if ($this->_items)
			    {
					...
					<td class="jsn-column-select">
						<?php echo JHtml::_('grid.id', $i, $item->data_id); ?>
					</td>
					    <?php
					...
					<td class="jsn-column-id">
						<?php echo $item->data_id; ?>
					</td>
					<td>
					    <a class="jsn-link-action" href="<?php echo JRoute::_('index.php?option=com_uniform&view=submission&data_id=' . (int) $item->data_id ); ?>"><?php echo JText::_('JSN_UNIFORM_DETAIlS'); ?></a>
					</td>
				    </tr>
					    <?php
				    }
