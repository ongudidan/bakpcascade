...
<div class="jsn-bootstrap">
    ...
    <form action="<?php echo JRoute::_('index.php?option=com_uniform&view=emailsettings&layout=config&tmpl=component'); ?>" class="form-horizontal" method="post" name="adminForm" id="uni-form">
