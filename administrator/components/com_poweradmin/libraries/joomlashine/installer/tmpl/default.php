<?php
/**
 * @version    $Id: default.php 18549 2012-11-20 03:12:52Z cuongnm $
 * @package    JSN_Sample
...
{
?>
			<h1><?php echo JText::sprintf('JSN_EXTFW_INSTALLER_SUBTITLE', JText::_((string) $this->xml->name)); ?></h1>
			...
			<div id="jsn-installer-finalization">
				<div class="control-group">
					<label class="checkbox" for="jsn-installer-live-update-notification">
						...
						<strong><?php echo JText::sprintf('JSN_EXTFW_INSTALLER_LIVE_UPDATE_NOTIFICATION_LABEL', JText::_((string) $this->xml->name)); ?></strong>
					</label>
