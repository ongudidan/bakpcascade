		...
		JSNGrid.publishing = {
			...
			cookie : {
				enableUnpublished : function(){
					...
					JSNGrid.publishing.elementMode.removeClass('disabled').addClass('enabled').attr('title', JSNLang.translate('TITLE_HIDE_UNPUBLISHED_MODULES_POSITIONS'));
				},
				disableUnpublished : function(){
					$.jStorage.set('rawmode_unpublished_enabled', false);
					JSNGrid.publishing.elementMode.removeClass('enabled').addClass('disabled').removeAttr('class').attr('title', JSNLang.translate('TITLE_SHOW_UNPUBLISHED_MODULES_POSITIONS'));
				},
								...
								baseUrl+'administrator/index.php?option=com_config&view=component&component=com_modules&path=&tmpl=component', 
								{
									...
									buttons: {										
										'Save': function(){
											...
											if (pop.submitForm('component.apply', 'Save')){
												iframe.load(function(){
					...
					objs.unbind("click").click(function(e){
						try{
							if ( !e.ctrlKey  ){
								...
								publishingItem.text( publishingText );
								...
								if ( JSNGrid.grid.multipleselect.hasSelected( $(this) ) && JSNGrid.grid.multipleselect.hasChildSelected( JSNGrid.grid.elementContainer ) ){
									submenu.getItem( JSNLang.translate('TITLE_SUBMENU_EDIT') ).disableEventHandler("click").addClass('disable').attr('title', JSNLang.translate("JSN_RAWMODE_EDIT_NOTALLOWED_SHOW_HINT"));									
									...
									submenu.getItem( JSNLang.translate( 'TITLE_SUBMENU_ASSIGN_ONLY_TO_THIS_PAGE' ) ).changeProxy("click", "multipleselect");
									submenu.getItem( JSNLang.translate( 'TITLE_SUBMENU_ASSIGN_TO_ALL_PAGES' ) ).changeProxy("click", "multipleselect");
									submenu.getItem( JSNLang.translate( 'TITLE_SUBMENU_ASSIGN_TO_ONLY_TO_CUSTOM_PAGE' ) ).changeProxy("click", "multipleselect");
									submenu.getItem( JSNLang.translate( 'TITLE_SUBMENU_UNASSIGN_FROM_THIS_PAGE_ONLY' ), 1 ).changeProxy("click", "multipleselect");
									submenu.getItem( JSNLang.translate( 'TITLE_SUBMENU_UNASSIGN_FROM_ALL_PAGES' ), 1 ).changeProxy("click", "multipleselect");
									submenu.getItem( JSNLang.translate( 'TITLE_SUBMENU_UNASSIGN_CUSTOM_PAGES' ), 1 ).changeProxy("click", "multipleselect");
									...
									if(submenu.getRoot().find('.checked-out').length > 0) {
										submenu.getItem( JSNLang.translate('TITLE_SUBMENU_EDIT') ).disableEventHandler("click").addClass('disable').attr('title', JSNLang.translate("JSN_RAWMODE_EDIT_CHECKEDOUT_SHOW_HINT"));	
									}else{
										submenu.getItem( JSNLang.translate('TITLE_SUBMENU_EDIT') ).enableEventHandler("click").removeClass('disable').attr('title', '');										
									}
									submenu.getItem( JSNLang.translate( 'TITLE_CHANGE_POSITION' ) ).changeProxy("click", "click");
									publishingItem.changeProxy("click", "click");
									submenu.getItem( JSNLang.translate( 'TITLE_SUBMENU_ASSIGN_ONLY_TO_THIS_PAGE' ) ).changeProxy("click", "click");
									submenu.getItem( JSNLang.translate( 'TITLE_SUBMENU_ASSIGN_TO_ALL_PAGES' ) ).changeProxy("click", "click");
									submenu.getItem( JSNLang.translate( 'TITLE_SUBMENU_ASSIGN_TO_ONLY_TO_CUSTOM_PAGE' ) ).changeProxy("click", "click");
									submenu.getItem( JSNLang.translate( 'TITLE_SUBMENU_UNASSIGN_FROM_THIS_PAGE_ONLY' ), 1 ).changeProxy("click", "click");
									submenu.getItem( JSNLang.translate( 'TITLE_SUBMENU_UNASSIGN_FROM_ALL_PAGES' ), 1 ).changeProxy("click", "click");
									submenu.getItem( JSNLang.translate( 'TITLE_SUBMENU_UNASSIGN_CUSTOM_PAGES' ), 1 ).changeProxy("click", "click");
		...
		JSNGrid.editModule = function( moduleItem ){
			...
			(
				baseUrl+'administrator/index.php?option=' + comModule + '&task=module.edit&tmpl=component&id='+mid,
				{
					...
					buttons: {						
						'Save': function(){
							if (pop.submitForm('module.apply', 'Save')){
								var _this  = $(this);
								var iframe = $(this).find('iframe');
								_this.addClass('jsn-loading');
