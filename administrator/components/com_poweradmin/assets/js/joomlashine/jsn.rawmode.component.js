	...
	/**
	 ...
	 $.JSNComponent = function( option, view, layout, itemid ){
		...
		this.ajaxRequest = function(){
			...
			$.post
			(
				baseUrl+'administrator/index.php?option=com_poweradmin&task=component.request', 
				{
		...
		this.loadScript = function( option, view, layout ){
			...
			$.post
			(
				baseUrl+'administrator/index.php?option=com_poweradmin&task=component.checkScript', 
				{
					scriptFolder: option,
		...
		this.__construct = function( option, view, layout, mId ){
			...
			this.mode.unbind("click").click(function(){
				if ( !$(this).hasClass('enabled') ){
					com.setMode(true);
					com.mode.removeClass('disabled').addClass('enabled').attr('title', JSNLang.translate('TITLE_HIDE_DISABLED_COMPONENT_ELEMENTS') );
					com.container.addClass('active-mode');
					com.showUnpublished();
				}else{
					com.setMode(false);
					com.mode.removeClass('enabled').addClass('disabled').removeAttr('class').attr('title', JSNLang.translate('TITLE_SHOW_DISABLED_COMPONENT_ELEMENTS'));
			...
			if ( this.getMode() ){
				this.mode.removeClass('disabled').addClass('enabled').attr('title', JSNLang.translate('TITLE_HIDE_DISABLED_COMPONENT_ELEMENTS') );
				this.container.addClass('active-mode');
				this.showUnpublished();
			}else{
				this.mode.removeClass('enabled').addClass('disabled').removeAttr('class').attr('title', JSNLang.translate('TITLE_SHOW_DISABLED_COMPONENT_ELEMENTS'));
