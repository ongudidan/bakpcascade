...
<div class="jsn-bootstrap">
	<form name="adminForm" action="index.php?option=com_poweradmin&view=component" method="post" class="form-horizontal">
		<div class="control-group">
			...
			<div class="controls">
				<input type="text" class="input-mini" name="num_leading_articles" id="num_leading_articles" value="<?php echo $this->params->get('num_leading_articles');?>" />
		...
		<div class="control-group">
			...
			<div class="controls">
				<input type="text" class="input-mini" name="num_intro_articles" id="num_intro_articles" value="<?php echo $this->params->get('num_intro_articles');?>" />
				<span class="help-inline"><?php echo JText::_('JSN_RAWMODE_COMPONENT_ARTICLE');?></span>
				<a class="btn btn-mini apply-setting-area">
		...
		<div class="control-group">
			<div class="controls">
				...
				<input type="text" class="input-mini" name="num_columns" id="num_columns" value="<?php echo $this->params->get('num_columns');?>" />
		...
		<div class="control-group">
			...
			<div class="controls">
				<input type="text" class="input-mini" name="num_links" id="num_links" value="<?php echo $this->params->get('num_links');?>" />
