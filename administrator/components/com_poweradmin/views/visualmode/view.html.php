...
class PoweradminViewVisualmode extends JViewLegacy
{
	...
	*/
	protected function addToolBar()
	{
		...
		JToolBarHelper::custom('', 'rawmode.png', 'rawmode.png', 'TOOLBAR_JSN_POWERADMIN_VISUAL_RAWMODE', false);
		JToolBarHelper::divider();
	...
	protected function addMedia()
	{
		...
		$JSNMedia->addScript(JSN_POWERADMIN_LIB_JSUILAYOUT_URI. 'jquery.layout-latest.js');
		...
		$JSNMedia->addScript(JSN_POWERADMIN_LIB_JSNJS_URI. 'jsn.visualmode.js');
