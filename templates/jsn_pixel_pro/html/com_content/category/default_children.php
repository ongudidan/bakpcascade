	...
	<?php foreach($this->children[$this->category->id] as $id => $child) : ?>
		...
		<div<?php echo $class; ?>>
			...
			<h3 class="page-header item-title"><a href="<?php echo JRoute::_(ContentHelperRoute::getCategoryRoute($child->id));?>">
				...
				<a href="#category-<?php echo $child->id;?>" data-toggle="collapse" data-toggle="button" class="btn btn-mini pull-right collapsed">
					<i class="icon-plus"></i>
...
<ul>
	...
	<li<?php echo $class; ?>>
		<?php $class = ''; ?>
		<a class="category" href="<?php echo JRoute::_(ContentHelperRoute::getCategoryRoute($child->id));?>"> <?php echo $this->escape($child->title); ?></a>
		<?php if ($this->params->get('show_subcat_desc') == 1) :?>
		<?php if ($child->description) : ?>
