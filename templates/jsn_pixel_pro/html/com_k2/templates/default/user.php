<?php
/**
 * @version		$Id: user.php 19563 2012-12-19 10:54:12Z tuyetvt $
 * @package		K2
		...
		<div class="userItemView<?php if(!$item->published || ($item->publish_up != $this->nullDate && $item->publish_up > $this->now) || ($item->publish_down != $this->nullDate && $item->publish_down < $this->now)) echo ' userItemViewUnpublished'; ?><?php echo ($item->featured) ? ' userItemIsFeatured' : ''; ?>">
			...
			<div class="userItemHeader">
			  ...
			  <h3 class="userItemTitle">
				...
				<?php endif; ?>
				<?php if($this->params->get('userItemDateCreated') || $this->params->get('userFeedIcon',1)): ?>
		  ...
		  <div class="userItemBody">
			...
			<div class="clr"></div>
			<?php if(($this->params->get('userItemCommentsAnchor') && ( ($this->params->get('comments') == '2' && !$this->user->guest) || ($this->params->get('comments') == '1'))) || $this->params->get('userItemReadMore')): ?>
			...
			<div class="userItemLinks">
				...
				<!-- Item category name -->
				<div class="userItemCategory"> <span><?php echo JText::_('K2_PUBLISHED_IN'); ?></span>
